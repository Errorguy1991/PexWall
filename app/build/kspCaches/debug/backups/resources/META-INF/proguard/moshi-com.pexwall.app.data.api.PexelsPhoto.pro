...
-keepclassmembers class com.pexwall.app.data.api.PexelsPhoto {
    public synthetic <init>(int,int,int,java.lang.String,java.lang.String,java.lang.String,int,java.lang.String,com.pexwall.app.data.api.PhotoSrc,java.lang.String,int,kotlin.jvm.internal.DefaultConstructorMarker);
}
